...
function GameCard(game) {
    return Deact.create("section", { class: `game-card` }, [
        ...
        // Deact.create("h6", { class: `game-card__category` }, game.category),
        Deact.create("img", { class: `game-card__imageUrl`, src: `${game.imageUrl}`, alt: `${game.title}` }, ""),
        // Deact.create("h7", { class: `game-card__publisher`}, game.publisher),
        // Deact.create("h8", { class:  `game-card__system` }, game.system)
    ]);
}
